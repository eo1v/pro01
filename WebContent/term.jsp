...
<head>
    ...
    .page.after { content: ""; display: block; clear: both;} /*자식이 flowleft,'' 걸렸을 때 */
    .page_title { padding-top: 1em; text-align: center;}
    .page_wrap { width: 1200px; margin: 0 auto;}
    
    .agree_fr { width: 900px; white-space:pre-wrap; margin: 10px auto; 
    padding: 24px; border:2px solid rgb(235, 235, 235); height:600px; overflow-y:auto; }
 
    .frm {border: 5px solid rgb(203, 223, 237); padding: 30px; width: 300px; margin: 50px auto;}
    .frm_fr { display: block; margin: 10px;  }
    .frm_fr .ft { float: center; }
    .frm_fr li { display:table; margin:10px auto;  }
    .in_btn {cursor:pointer; display: block; border : 1px; background-color: rgb(197, 240, 226);  min-width: 120px; height: 32px; margin: 3px;}
    .in_btn:hover { background-color: rgb(238, 137, 101);}
                ...
                <nav class="gnb">
                    <ul>
                        ...
                        <li class="item2">
                            ...
                            <ul class="sub">
                                <li><a href="">듀오세트</a></li>
                                <li><a href="">퍼퓸핸드미니7</a></li>
                                <li><a href="">손소독제트리오</a></li>
                            </ul>
                        </li>
                        <li class="item3">
